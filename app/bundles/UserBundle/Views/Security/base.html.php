...
<head>
    <meta charset="UTF-8" />
    <title><?php echo $view['slots']->get('pageTitle', 'MotaWord'); ?></title>
                ...
                <div class="panel" name="form-login">
                    <div class="panel-body">
                        <div class="mautic-logo img-circle mb-md text-center" style="width:{{login_logo_width}}px;">
                            <img src="<?php echo $view['assets']->getUrl('media/images/mw-square.png') ?>" style="width:{{login_logo_width}}px; margin:{{login_logo_margin_top}}px 0 {{login_logo_margin_bottom}}px 0;" />
                        </div>
