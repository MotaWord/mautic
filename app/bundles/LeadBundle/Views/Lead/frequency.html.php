                    ...
                    <td class="col-md-9" style="vertical-align: top">
                            <div>
                                <div class="pull-left">
                                    ...
                                    <?php
                                    $attr = $form['frequency_unit_'.$channel->value]->vars['attr'];
                                    $attr['class'] .= ' pull-left';
                                    ?>
                                    <?php echo $view['form']->label($form['frequency_unit_'.$channel->value], ['attr' => $attr]); ?>
                                    <?php echo $view['form']->widget($form['frequency_unit_'.$channel->value], ['attr' => $attr]); ?>
