    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-1">
                        <?php echo $view['form']->label($fields['email_frequency_time']); ?>
                    </div>
                    <div class="col-md-1">
                        <?php echo $view['form']->widget($fields['email_frequency_unit']); ?>
                    </div>
                    <div class="col-md-10">
                        <?php echo $view['form']->widget($fields['email_frequency_time']); ?>
                    </div>
                </div>
            </div>
        </div>
